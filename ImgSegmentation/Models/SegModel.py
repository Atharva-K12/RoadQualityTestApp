...
class R2U_Net(nn.Module):
    ...
    """
    def __init__(self, img_ch=3, output_ch=1,n1=64,t=2):
...
class R2AttU_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=3, out_ch=1,n1=64, t=2):
...
class SegModel(nn.Module):
    def __init__(self,in_ch=3, out_ch=1, filter_base=32,loss="MSE",optimizer="Adam",lr=0.001,model="UNet"):
    ...
    def loss(self, x, y):
        ...
        elif self.select_loss == "SmoothL1":
    ...
    def select_model(self):
        if self.model == "UNet":
            return UNET(self.in_ch,self.out_ch,self.filter_base)
        elif self.model == "NestedUNet":
            return NestedUNet(self.out_ch,self.filter_base)
        elif self.model == "R2U_Net":
            return R2U_Net(self.in_ch,self.out_ch,self.filter_base)
        elif self.model == "AttU_Net":
            return AttU_Net(self.in_ch,self.out_ch,self.filter_base)
        elif self.model == "R2AttU_Net":
            return R2AttU_Net(self.in_ch,self.out_ch,self.filter_base)
        else:
